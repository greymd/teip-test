...
<!-- deb_url_start -->
```bash
wget https://github.com/greymd/teip-test/releases/download/v2.3.2/teip-2.3.2.$(uname -m)-unknown-linux-musl.deb
...
<!-- rpm_url_start -->
```bash
sudo dnf install https://github.com/greymd/teip-test/releases/download/v2.3.2/teip-2.3.2.$(uname -m)-unknown-linux-musl.rpm
```
<!-- rpm_url_end -->
...
<!-- rpm_url_start -->
```bash
sudo yum install https://github.com/greymd/teip-test/releases/download/v2.3.2/teip-2.3.2.$(uname -m)-unknown-linux-musl.rpm
```
<!-- rpm_url_end -->

<!-- release_url_start -->
If necessary, check the hash value from the [latest release page](https://github.com/greymd/teip-test/releases/tag/v2.3.2).
...
<!-- ins_url_start -->
Download installer from [here](https://github.com/greymd/teip-test/releases/download/v2.3.2/teip_installer-2.3.2-x86_64-pc-windows-msvc.exe).
<!-- ins_url_end -->
...
<!-- release_url_start -->
Check the [latest release page](https://github.com/greymd/teip-test/releases/tag/v2.3.2) for executables for the platform you are using.
<!-- release_url_end -->
